...
export const mockItems: Item[] = [
   {
      ...
      sustainabilityNote:
         "Made from organic cotton, using 88% less water and 62% less energy than conventional cotton.",
   },
   {
      id: 2,
      itemName: "Wool Sweater",
      brand: "Sustainable Co.",
      materials: [{ type: "wool", percentage: 100 }],
      image: "https://picsum.photos/200/300",
      sustainabilityNote:
         "Sourced from responsible wool standard certified farms.",
   },
];
