...
export default function AddItemForm() {
   ...
   const materials: MaterialEntry[] = [{ type: "wool", percentage: 65 }];
         ...
         <form className="space-y-8">
            ...
            <div className="space-y-4">
               <div className="flex items-center justify-between">
                  ...
                  <RoundedButton>+ Add Material</RoundedButton>
               </div>
                     ...
                     <div key={index} className="flex gap-4 items-start">
                        ...
                        <div className="w-48">
                           ...
                           <div className="flex items-center gap-2 mt-1">
                              ...
                              {materials.length > 1 && (
                                 <RoundedButton className="text-red-500 hover:text-red-700">
                                    Remove
                                 </RoundedButton>
                              )}
                           </div>
            ...
            <div className="bg-gray-50 p-4 rounded-lg">
               ...
               <ul className="text-sm text-gray-600 space-y-1 list-disc list-inside">
                  ...
                  <li>
                     Clear, well-lit photos will help you identify items easily
                  </li>
               </ul>
            </div>
